...
DUMMY_OUTPUT = dedent("""\
    ...
    <detected_kwlist kwid="1" oov_count="0" search_time="0.0">
        <kw file="1.wav" channel="1" tbeg="0.0" dur="0.0" word="one" score="0.0" decision="true"/>
        <kw file="1.wav" channel="1" tbeg="0.0" dur="0.0" word="one" score="0.0" decision="true"/>
    </detected_kwlist>
    <detected_kwlist kwid="2" oov_count="0" search_time="0.0">
        <kw file="2.wav" channel="1" tbeg="0.0" dur="0.0" word="two" score="0.0" decision="true"/>
        <kw file="2.wav" channel="1" tbeg="0.0" dur="0.0" word="two" score="0.0" decision="true"/>
    </detected_kwlist>
...
def test_parse_output_xml():        
    ...
    assert detected_kwlist.list_kw[0].word == 'one'
    ...
    assert detected_kwlist.list_kw[1].word == 'one'
    ...
    assert detected_kwlist.list_kw[0].tbeg == 0.0
    assert detected_kwlist.list_kw[0].dur == 0.0
    assert detected_kwlist.list_kw[0].word == 'two'
    assert detected_kwlist.list_kw[0].score == 0.0
    assert detected_kwlist.list_kw[0].decision == True
